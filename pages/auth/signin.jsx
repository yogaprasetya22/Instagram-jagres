...
const SignIn = ({ providers }) => {
    return (
        <>
            <Headers />
            <div className="flex h-[30rem]  justify-center items-center flex-col px-20">
                <img
                    className="w-80 h-40 "
                ...
                <p className="font-xs italic text-center">
                    Ini Aplikasi Instagram Clone, dengan teknologi Next.js
                    sebagai framework dan firebase untuk authentication.
                </p>
                <div className="mt-10">
